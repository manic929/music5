// NOW CLICK album-poster TO GET CURRENT SONG ID
		...
		const ap = new APlayer({
		    ...
		    },
			{
		        ...
		        cover: 'images/3.jpg' // COVER IMAGE
		    },
            {
